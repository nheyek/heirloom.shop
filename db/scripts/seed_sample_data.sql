...
BEGIN
    ...
    VALUES
        ...
        (sample_listing_5_id,  'Qa0Z', sample_listing_5_shop_id,  sample_listing_5_category_id,  sample_listing_5_title,  sample_listing_5_subtitle,  sample_listing_5_full_descr, sample_listing_5_price_cents,  sample_shop_2_shipping_profile_id, sample_shop_2_return_profile_id, sample_listing_5_image_uuids,  sample_shop_2_processing_profile_id, null,
            ...
            jsonb_build_object(
                sample_listing_5_species_variation_id || ':' || sample_listing_5_species_walnut_id || '|' || sample_listing_5_variation_id || ':' || sample_listing_5_option_1_id, jsonb_build_object('priceCents', 315000, 'upc', '', 'imageUuid', null, 'disabled', false),
                sample_listing_5_species_variation_id || ':' || sample_listing_5_species_oak_id    || '|' || sample_listing_5_variation_id || ':' || sample_listing_5_option_1_id, jsonb_build_object('priceCents', 296700, 'upc', '', 'imageUuid', null, 'disabled', false),
                sample_listing_5_species_variation_id || ':' || sample_listing_5_species_maple_id  || '|' || sample_listing_5_variation_id || ':' || sample_listing_5_option_1_id, jsonb_build_object('priceCents', 305000, 'upc', '', 'imageUuid', null, 'disabled', false),
                sample_listing_5_species_variation_id || ':' || sample_listing_5_species_walnut_id || '|' || sample_listing_5_variation_id || ':' || sample_listing_5_option_2_id, jsonb_build_object('priceCents', 375000, 'upc', '', 'imageUuid', null, 'disabled', false),
                sample_listing_5_species_variation_id || ':' || sample_listing_5_species_oak_id    || '|' || sample_listing_5_variation_id || ':' || sample_listing_5_option_2_id, jsonb_build_object('priceCents', 349900, 'upc', '', 'imageUuid', null, 'disabled', false),
                sample_listing_5_species_variation_id || ':' || sample_listing_5_species_maple_id  || '|' || sample_listing_5_variation_id || ':' || sample_listing_5_option_2_id, jsonb_build_object('priceCents', 349900, 'upc', '', 'imageUuid', null, 'disabled', true),
                sample_listing_5_species_variation_id || ':' || sample_listing_5_species_walnut_id || '|' || sample_listing_5_variation_id || ':' || sample_listing_5_option_3_id, jsonb_build_object('priceCents', 469900, 'upc', '', 'imageUuid', null, 'disabled', false),
                sample_listing_5_species_variation_id || ':' || sample_listing_5_species_oak_id    || '|' || sample_listing_5_variation_id || ':' || sample_listing_5_option_3_id, jsonb_build_object('priceCents', 429900, 'upc', '', 'imageUuid', null, 'disabled', false),
                sample_listing_5_species_variation_id || ':' || sample_listing_5_species_maple_id  || '|' || sample_listing_5_variation_id || ':' || sample_listing_5_option_3_id, jsonb_build_object('priceCents', 429900, 'upc', '', 'imageUuid', null, 'disabled', true)
            )
        ),

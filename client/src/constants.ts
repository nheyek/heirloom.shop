...
export const ABOUT_HEIRLOOM_HTML =
	'<p>Heirloom is an online store and marketplace featuring a wide range of products from makers that exhibit the highest level of craftsmanship.</p><p />' +
	'<h1>Background</h1>' +
	'<p>Mass consumerism and throw-away culture are, sadly, a defining feature of the present historical moment.</p>' +
	"<p>Disillusionment is on the rise, though. People are beginning to ask questions about where their products come from, how they're made, and what they're made of.</p><p />" +
	'<h1>The Heirloom Experience</h1>' +
	'<p>"They don\'t make them like they used to" is a common refrain. In most cases, though, there is someone still making things the right way. They are just hard to find.</p>' +
	'<p>Heirloom seeks to make it easy to find these makers and to purchase their work.</p>' +
	...
	'<h1>Who We Are</h1>' +
	'<p>Heirloom was founded and developed by Nick Heyek, a Chicago-based software engineer and amateur craftsman.</p>' +
